const Banner = () => {
    return (
        <div className="bg-[linear-gradient(45deg,rgba(0,0,0,0.5),rgba(0,0,0,0.1)),url('./banner.png')] bg-no-repeat w-full bg-cover mt-12 rounded-xl  bg-center">
            <h1 className="lg:text-4xl font-medium max-w-[600px] px-4 mx-auto text-3xl text-white text-center pt-[140px]"><span className="inline-block pb-3">FlavorySimply Recipes:</span> <br />
            Explore Culinary Delights with Our Recipes Blog</h1>
